...
print(df5.head(20))
# print(df5.dtypes)
# df5.sort_values(by = '总笔数',inplace = True,ascending=False)
print('------'*10)
df5 = df5.groupby(level=['MCHT_CD','MONTH'],axis=0).apply(lambda x: x.sort_values('总笔数', ascending=False))
print(df5.head())
df5.to_csv('total\order_is_cash_3_hz_mon.csv', encoding='gbk', index=True)